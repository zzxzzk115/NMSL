...
/// </summary>
/// <remarks>This interface provides asynchronous methods for controlling media playback. Implementations  of this
/// interface are expected to handle media playback state transitions and navigation  between media items. All methods
/// return <see cref="Task"/> to support asynchronous execution.</remarks>
